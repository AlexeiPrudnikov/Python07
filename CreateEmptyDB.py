...
cur.execute("""Insert into TelephoneBook(pID, tbNumber, ttID) values (2, "111", 1);""")
cur.execute("""Insert into TelephoneBook(pID, tbNumber, ttID) values (2, "111", 2);""")
cur.execute("""Insert into TelephoneBook(pID, tbNumber, ttID) values (2, "111", 3);""")
